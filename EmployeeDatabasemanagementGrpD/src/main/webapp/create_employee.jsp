			...
			<td>
				<form action="CreateEmployeeServlet" method="post">
					...
					<input type="date"name="DateOfResignation" id="datepicker" style="width:38%; border: 1px solid;"><br/><br/>
					 ...
					 <select name="department" id="department" style="width:54%; border: 1px solid;">
					...
					<label  style="font-size:20px;">Location:</label>
					 <select name="location" id="location" style="width:58%; border: 1px solid;">
					...
					<input type="text" name="Username" style="width:54%; border: 1px solid;"><br/><br/>
					
					<input type="submit" value="Create Employee" style="height:30px; width:200px; font-size:20px;">
			</form>
			</td>
		</tr>
	</table>
